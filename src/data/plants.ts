// This file contains the plant data that was previously in PlantCatalog.tsx
export const plantCategories = [
  {
    ...
    plants: [
      ...
      { name: "3 test mango", price: "₹380" },
      { name: "Bari 4 mango", price: "₹350" },
  ...
  },
  {
    ...
    plants: [
      ...
      { name: "White guava", price: "₹200" },
      { name: "Strawberry guava", price: "₹250" },
      { name: "Apple guava", price: "₹250" },
      { name: "Lemon guava", price: "₹250" },
      { name: "Vietnamese guava", price: "₹300" },
      { name: "Giant guava", price: "₹350" },
      { name: "Dwarf guava", price: "₹400" }
    ]
  },
